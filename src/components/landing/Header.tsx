...
const Header: React.FC = () => {
  ...
  const { totalQuantity } = useCartQuery();

  // Handle scroll monitoring AND set mount state safely
  useEffect(() => {
    setIsMounted(true);
    ...
    <>
      ...
      >
        ...
        <div className="px-4 lg:px-8 max-w-7xl mx-auto h-16 lg:h-20 flex items-center justify-between gap-4">
          ...
          {/* Middle/Right: Enterprise Search Bar (Sharp 2px custom corners) */}
          ...
          <div className="flex items-center gap-1 lg:gap-3 shrink-0">
            ...
            {/* Micro-Cart Interface Component - Guarded */}
            <Link
              href="/cart"
            ...
            {/* Authentic Identity Action Block - Guarded */}
            <Link
              href={isMounted && user ? "/buyer/account/overview" : "/auth/buyer/login"}
            ...
            <Link
              href={isMounted && user ? "/buyer/account/profile" : "/auth/buyer/login"}
